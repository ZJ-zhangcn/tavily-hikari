...
const strings = {
  ...
  trendsDescription: 'Charts use a rolling 24-hour hourly window; yesterday/previous-month comparisons stay complete and missing buckets are left blank.',
  ...
  chartUtcWindow: 'Local time axis · Rolling 24 hours ({count} current buckets, {comparisonCount} comparison buckets)',
...
const zhStrings = {
  ...
  unknownTag: '未知',
  trendsTitle: '流量趋势',
  trendsDescription: '图表使用滚动的最近 24 小时小时窗；昨日/上月对比保持完整，缺失小时留空不补。',
  requestTrend: '请求量',
  errorTrend: '错误量',
  ...
  chartUtcWindow: '本地时间横轴 · 最近 24 小时（当前 {count} 组，对比 {comparisonCount} 组）',
