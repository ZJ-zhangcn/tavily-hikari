    ...
    admin: {
      ...
      systemSettings: {
        ...
        form: {
          ...
          gatewaySectionTitle: 'Session 亲和与 Rebalance', apiRebalanceTitle: 'Tavily API Rebalance', upstreamIdentityTitle: '上游身份与隐私', requestRateLimitLabel: '5 分钟最大请求数',
          ...
          currentUpstreamProjectIdModeValue: '当前模式：{value}',
          currentUpstreamProjectIdFixedValue: '当前固定值：{value}',
          ...
          currentUpstreamMcpUserAgentValue: '当前 UA：{value}',
