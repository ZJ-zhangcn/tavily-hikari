...
export const EN: TranslationShape = {
    ...
    admin: {
      ...
      dashboard: {
        ...
        trendsDescription: 'Charts use a rolling 24-hour hourly window; yesterday and previous-month comparisons stay complete, with missing buckets left blank.',
