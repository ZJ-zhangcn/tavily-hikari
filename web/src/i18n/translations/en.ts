    ...
    admin: {
      ...
      systemSettings: {
        ...
        form: {
          ...
          upstreamPreciseReconciliationHint: 'When off, the new scheme still produces shadow reconciliation results without changing real quota; the user usage list shows the new daily usage for comparison.',
          upstreamPreciseReconciliationEnabledValue: 'Current: the new scheme writes real adjustments.',
          upstreamPreciseReconciliationDisabledValue: 'Current: comparison only; real billing is unchanged.',
      ...
      users: {
        ...
        usage: {
          ...
          back: 'Back to users',
          shadowComparisonValue: 'New scheme {usage} · {delta}',
          table: {
            user: 'User',
            status: 'Status',
            hourlyAny: '5m Rate',
