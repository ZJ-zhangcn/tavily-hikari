...
export const EN: TranslationShape = {
    ...
    admin: {
      ...
      dashboard: {
        ...
        trendsDescription: 'Charts use 24 complete hourly slots plus the current partial hour; yesterday and previous-month comparisons stay complete, with missing buckets left blank.',
      ...
      systemSettings: {
        ...
        form: {
          ...
          gatewaySectionTitle: 'Session affinity and Rebalance', apiRebalanceTitle: 'Tavily API Rebalance', upstreamIdentityTitle: 'Upstream identity and privacy', requestRateLimitLabel: 'Max requests per 5 minutes',
          ...
          currentUpstreamProjectIdModeValue: 'Current mode: {value}',
          currentUpstreamProjectIdFixedValue: 'Current fixed value: {value}',
          ...
          currentUpstreamMcpUserAgentValue: 'Current UA: {value}',
