...
const EXCEPTIONS: &[(&str, usize, &str)] = &[
    (
        "src/models.rs",
        3175,
        "Alert center semantic DTO growth plus the pressure moving-average DTOs both extend the shared model surface while the broader extraction pass remains pending.",
    ),
    (
